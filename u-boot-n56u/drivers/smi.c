...
gpioID smi_SCK = 23;	/* GPIO used for SMI Clock Generation */	/* GPIO23 */
gpioID smi_SDA = 22;	/* GPIO used for SMI Data signal */		/* GPIO22 */
gpioID smi_RST = 24;	/* GPIO used for reset swtich */		/* GPIO24 */
...
extern void reset_phy_gpio_realtek(void);
...
extern void smi_init_gpio_realtek(void);
