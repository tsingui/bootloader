...
/* Jiahao++
	printf("dev->enetaddr before: [%02X:%02X:%02X:%02X:%02X:%02X]\n",
	...
	printf("dev->enetaddr after: [%02X:%02X:%02X:%02X:%02X:%02X]\n",
		dev->enetaddr[0],dev->enetaddr[1],dev->enetaddr[2],
		dev->enetaddr[3],dev->enetaddr[4],dev->enetaddr[5]);
*/
...
// those for modification for RT-N56U
//	printf("\n Vitesse giga Mac support \n");
...
//
	...
	RALINK_REG(MDIO_CFG)=cpu_to_le32((u32)(0x1F01D001));	
