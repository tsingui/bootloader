...
// Jiahao++
				CFG_FACTORY_ADDR + RAMAC0_OFFSET, 6);
#endif

// Jiahao++
/*
	printf("rt2880_gmac1_mac before: [%02X:%02X:%02X:%02X:%02X:%02X]\n",
		(unsigned char)rt2880_gmac1_mac[0],(unsigned char)rt2880_gmac1_mac[1],(unsigned char)rt2880_gmac1_mac[2],
		(unsigned char)rt2880_gmac1_mac[3],(unsigned char)rt2880_gmac1_mac[4],(unsigned char)rt2880_gmac1_mac[5]);
*/
...
/*
				rt2880_gmac1_mac[0] = 0x00;
				rt2880_gmac1_mac[1] = 0x11;
				rt2880_gmac1_mac[2] = 0x11;
				rt2880_gmac1_mac[3] = 0x11;
				rt2880_gmac1_mac[4] = 0x11;
				rt2880_gmac1_mac[5] = 0x11;
*/
			}

/*
	printf("rt2880_gmac1_mac after:  [%02X:%02X:%02X:%02X:%02X:%02X]\n",
		(unsigned char)rt2880_gmac1_mac[0],(unsigned char)rt2880_gmac1_mac[1],(unsigned char)rt2880_gmac1_mac[2],
		(unsigned char)rt2880_gmac1_mac[3],(unsigned char)rt2880_gmac1_mac[4],(unsigned char)rt2880_gmac1_mac[5]);
*/
