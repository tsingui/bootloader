...
unsigned long flash_init (void)
{
	...
	int i;
	sys_config_t *  sys_data= ( sys_config_t * ) ( CFG_SDRAM_BASE + SYSCFG_OFFSET );
...
{
	unsigned int  res;
	unsigned int offset = (unsigned int)block -  CFG_FLASH_BASE;
...
{
	unsigned int  res;
	unsigned int  offset = (unsigned int )addr -  CFG_FLASH_BASE;
	unsigned int  data = 0;
	int data_len;
